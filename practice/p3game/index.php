...
<html lang='en'>
  ...
  <body>
    ...
    <ul>
      ...
      <li>After you play, take the <a title="WBA Trivia Challenge" href="http://practice.loc/p3game/wbatrivia.php">WBA Trivia Challenge.</a></li>
    </ul>  
 ...
 <!-- Name of Player goes after Results h2 unless Player does not enter a name, then just the Results h2 header will return -->
    ...
    <h2><a class='or' title="WBA Trivia Challenge" href="http://practice.loc/p3game/wbatrivia.php">Or Click here to take the WBA Trivia Challenge!</a></h2>
